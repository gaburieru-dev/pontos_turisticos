  ...
  Future<List<PontosTuristicos>> listar({
    ...
    final resultado = await database.query(
      ...
      columns: [
        ...
        PontosTuristicos.campoNome,
        PontosTuristicos.campoDiferenciais,
        PontosTuristicos.campoInclusao,
        PontosTuristicos.campoLatitude,
        PontosTuristicos.campoLongitude,
        PontosTuristicos.campoCep,
      ],
      where: where,
      orderBy: orderBy,
    );
