...
class _ListaPontosTuristicosPageState extends State<ListaPontosTuristicosPage>{
  ...
  Widget _criarBody(){
    ...
    if(_pontos.isEmpty){
      return const Center(
        child: Text('Não há pontos turísticos cadastrados',
  ...
  Future<bool> _verificaPermissoes() async{
    ...
    if(permissao == LocationPermission.denied){
      ...
      if(permissao == LocationPermission.denied){
        _mostrarMensagem('A funcionalidade não pode ser utilizada devido à ausência de permissão. Por gentileza, verifique as configurações do dispositivo e autorize o acesso ao serviço de localização.');
        return false;
      }
    }
    if(permissao == LocationPermission.deniedForever){
      await _mostrarMensagemDialog(
          'A funcionalidade não pode ser utilizada devido à ausência de permissão. Por gentileza, verifique as configurações do dispositivo e autorize o acesso ao serviço de localização.'
      );
